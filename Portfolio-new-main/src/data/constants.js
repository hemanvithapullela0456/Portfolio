...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "APIs",
        image:
          "https://cdn.prod.website-files.com/60f5b6738a95b57fe76faba5/6511e1868134bfd25c3ca5e0_What%20Is%20an%20API_.png",
      },
      {
        name: "MySQL",
        image:
  ...
  {
 title: ( <div> Android <small style={{ fontSize:'12px'}}><li>Working on it..</li></small></div> ),
...
export const experiences = [
  {
    ...
    desc: "I have completed a MERN Full Stack Web Development course at Apna College, where I gained hands-on experience in building full-stack applications using MongoDB, Express.js, React, and Node.js.",
    skills: [
      "Javascript",
      "HTML",
      "CSS",
...
export const projects = [
  ...
  //     "Tpye Description",
  //   image:
  //     "Project Thumbinal Image",
  //   tags: ["React Js", "API", "Axios", "Node JS"],
  //   category: "web app",
  //   github: "Project Cource Code",
  //   webapp: "PROJECT LINK",
  // },
  // {
  //   id: 7,
